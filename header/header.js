...
function headerchange(check)
{
	if(check==1)
	{
		...
		var img=document.getElementById('friends-home').src="../images/home-hover.png";
	}
	else if(check==2)
	{
		var text=document.getElementById('p2').style.color="white";
		var img=document.getElementById('friends-profile').src="../images/profile-hover.png";
	}
	else if(check==3)
	{
		var text=document.getElementById('p3').style.color="white";
		var img=document.getElementById('friends-society').src="../images/society-hover.png";
	}
	else if(check==4)
	{
		var text=document.getElementById('p4').style.color="white";
		var img=document.getElementById('friends-message').src="../images/message-hover.png";
	}
	else if(check==5)
	{
		var text=document.getElementById('p5').style.color="white";
		var img=document.getElementById('friends-notification').src="../images/notification-hover.png";
	}
}
...
function headerorigin(check)
{
	if(check==1)
	{
		...
		var img=document.getElementById('friends-home').src="../images/home.png";
	}
	else if(check==2)
	{
		var text=document.getElementById('p2').style.color="black";
		var img=document.getElementById('friends-profile').src="../images/profile.png";
	}
	else if(check==3)
	{
		var text=document.getElementById('p3').style.color="black";
		var img=document.getElementById('friends-society').src="../images/society.png";
	}
	else if(check==4)
	{
		var text=document.getElementById('p4').style.color="black";
		var img=document.getElementById('friends-message').src="../images/message.png";
	}
	else if(check==5)
	{
		var text=document.getElementById('p5').style.color="black";
		var img=document.getElementById('friends-notification').src="../images/notification.png";
	}
}
